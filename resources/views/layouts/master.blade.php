...
<div id="app" class="wrapper">
  ...
  <aside class="main-sidebar elevation-4 sidebar-light-maroon">
    ...
    <a href="index3.html" class="brand-link text-sm">
      <img src="https://image.shutterstock.com/image-vector/your-nature-logo-company-illustration-260nw-1643809627.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">CarTal</span>
    </a>
